...
# !!!!!!!!!THIS IS SET GLOBALLY!!!!!!!!!
  ...
  # rast_list_temp <- raster_data_read_fn(row_n = params$area_num)
# theme for small maps
  theme_maps_temp <- theme(
